...
() => {
    ...
    describe('Mediator', () => {
        describe('Convention subscription', function () {
            ...
            var mod: IThrustModuleInternal, module2: IThrustModuleInternal, s1, s2, s3, s4, f2, s5a, s6a, s7a, s8a, s5b, s6b, s7b, s8b, os1, os2, os3a, os3b, os4a, os4b, os5, os6, os7a, os7b, os8a, os8b;
                    ...
                    config: {
                        mediator: {
                            subscriptions: {
                                ...
                                'test-event4': <any[]>['event4', fakeContext],
                                'test-event5': [[s5a], [s5b]],
                                'test-event6': [['event6a'], ['event6b']],
                                'test-event7': [[s7a, fakeContext], [s7b, fakeContext]],
                                'test-event8': [<any[]>['event8a', fakeContext], <any[]>['event8b', fakeContext]],
                                'os-event1': {
                                    handler: os1,
                                },
                                'os-event2': {
            ...
            async.it('should have created subscriptions', function (done) {
                mod.start().then(() => {
                    ...
                    expect((<any>mod.instance.mediator)._internalSubscriptions.length).toBe(24);
                    expect((<any>mod.instance.mediator)._callbacks['test-event1']).toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['test-event2']).toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['test-event3']).toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['test-event4']).toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['test-event5']).toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['test-event6']).toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['test-event7']).toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['test-event8']).toBeDefined();

                    expect((<any>mod.instance.mediator)._callbacks['os-event1']).toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['os-event2']).toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['os-event3']).toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['os-event4']).toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['os-event5']).toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['os-event6']).toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['os-event7']).toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['os-event8']).toBeDefined();
            ...
            async.it('subscriptions unsubscribe', function (done) {
                var seq = [() => mod.start(), () => mod.stop()];
                when.sequence(seq).then(() => {
                    expect((<any>mod.instance.mediator)._internalSubscriptions).toBeNull();
                    expect((<any>mod.instance.mediator)._callbacks['test-event1']).not.toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['test-event2']).not.toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['test-event3']).not.toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['test-event4']).not.toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['test-event5']).not.toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['test-event6']).not.toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['test-event7']).not.toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['test-event8']).not.toBeDefined();
            ...
            async.it('subscriptions unsubscribe properly with multiple modules', function (done) {
                    ...
                    config: {
                        mediator: {
                            subscriptions: {
                                'test-event1': s1,
                                'test-event2': 'event2',
                                'test-event3': [s3, fakeContext2],
                                'test-event4': <any[]>['event4', fakeContext2]
                            }
                        }
                    }
                });
                ...
                when.sequence(seq).then(() => {
                    expect((<any> mod.instance.mediator)._internalSubscriptions).toBeNull();
                    expect((<any> module2.instance.mediator)._callbacks['test-event1']['module-test2']).toBeDefined();
                    expect((<any> module2.instance.mediator)._callbacks['test-event2']['module-test2']).toBeDefined();
                    expect((<any> module2.instance.mediator)._callbacks['test-event3']['module-test2']).toBeDefined();
                    expect((<any> module2.instance.mediator)._callbacks['test-event4']['module-test2']).toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['test-event1']['module-test1']).not.toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['test-event2']['module-test1']).not.toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['test-event3']['module-test1']).not.toBeDefined();
                    expect((<any>mod.instance.mediator)._callbacks['test-event4']['module-test1']).not.toBeDefined();
